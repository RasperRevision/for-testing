const html = `<header class="d-flex justify-content-between main_header align-items-center py-1">
  ...
  <ul class="nav d-flex align-items-center h-100">
    <li class="nav-item ms-3">
      <a class="text-white" href="/search/" title="Search">
    ...
    <li class="nav-item ms-3">
      <button class="btn p-0" title="Toggle dark theme">
    ...
    <li class="nav-item ms-3" title="Github">
    ...
    <li class="nav-item ms-3" title="Youtube">
