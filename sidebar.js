const html = `<header class="position-fixed w-100 d-flex justify-content-between main_header align-items-center py-1" style="z-index: 1000;">
  ...
  <ul class="nav d-flex align-items-center h-100">
    <li class="nav-item ms-3 d-none d-md-inline-flex">
      <a class="text-white header_link" href="/search/" title="Search">
    ...
    <li class="nav-item ms-3 d-none d-md-inline-flex">
      <button class="btn p-0 header_link" title="Toggle dark theme">
    ...
    <li class="ms-3 d-none d-md-inline-flex">
    |
    </li>
    <li class="nav-item ms-3 d-none d-md-inline-flex">
      <a class="text-white header_link" title="Github" href="https://github.com/RasperRevision/RasperRevision.github.io" target="_blank">
    ...
    <li class="nav-item ms-3 d-none d-md-inline-flex">
      <a class="text-white header_link" title="Youtube" href="https://www.youtube.com/@RasperRevision" target="_blank">
...
<div class="d-flex sidebar-wrapper position-fixed" id="wrapper">
  <div id="sidebar">
